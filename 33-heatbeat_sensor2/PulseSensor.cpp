...
bool PulseSensor::start()
{
    if (_started == false)
    {
        ...
        _pulseSensorTicker.attach(callback(this, &PulseSensor::sensor_ticker_callback), ((float)_sensorTickRateMs/1000));
        _processDataTicker.attach(callback(this, &PulseSensor::process_data_ticker_callback),  ((float)_callbackRateMs/1000));
